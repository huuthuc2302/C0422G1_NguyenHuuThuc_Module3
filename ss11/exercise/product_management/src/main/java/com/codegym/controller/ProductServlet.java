...
public class ProductServlet extends HttpServlet {
    ...
    private void searchByName(HttpServletRequest request, HttpServletResponse response) {
        ...
        if(productsList == null){
            ...
            dispatcher = request.getRequestDispatcher("view/products/search.jsp");
        }
        try {
    ...
    private void findNameProduct(HttpServletRequest request, HttpServletResponse response) {
        String name = request.getParameter("name");
        List<Products> productsList = productService.findByName(name);
        RequestDispatcher requestDispatcher= request.getRequestDispatcher("/view/products/search.jsp");
        request.setAttribute("productsList",productsList);
        try {
            requestDispatcher.forward(request,response);
        } catch (ServletException e) {

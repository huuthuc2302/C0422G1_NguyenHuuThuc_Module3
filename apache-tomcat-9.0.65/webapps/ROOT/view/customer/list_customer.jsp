        ...
        <div class="row">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a type="button" class="btn btn-primary" href="/customers?action=update&customerId=${customer.customerId}">
                            Sửa
                        </a></td>
                    </td>
                    <td>
                        <button type="button" onclick="showInfoDelete('${customer.customerId}','${customer.customerName}')" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            Xoá
                        </button>
                    </td>
                </tr>
